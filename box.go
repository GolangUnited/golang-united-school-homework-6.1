...
func (b *box) AddShape(shape Shape) error {
	...
	if len(b.shapes) < b.shapesCapacity {
		...
		//panic("Shape is not added, there is not enough capacity")
	}
}
...
func (b *box) ReplaceByIndex(i int, shape Shape) (Shape, error) {
	...
	//if b.shapes[i] != nil && i < len(b.shapes) {
	if i < len(b.shapes) {
		v := b.shapes[i]
		b.shapes[i] = shape
		return v, nil
